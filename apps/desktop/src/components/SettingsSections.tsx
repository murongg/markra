      ...
      {visibleMarkdownTemplates.length === 0 ? (
        ...
        <div className="settings-row py-4">
          <div className="settings-templates-layout grid grid-cols-[200px_minmax(0,1fr)] gap-5 max-[760px]:grid-cols-1">
            <ul
              className="m-0 flex max-h-[420px] min-h-18 list-none flex-col gap-0.5 overflow-y-auto border-r border-(--border-default) p-0 pr-3 max-[760px]:max-h-48 max-[760px]:border-r-0 max-[760px]:border-b max-[760px]:pb-3"
              role="list"
